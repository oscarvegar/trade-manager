...
public class BollingerBandsDataset extends AbstractXYDataset implements
	...
	public BollingerBandsSeries getSeries(int series) {
		...
		return (BollingerBandsSeries) this.data.get(series);
	}
	 ...
	 * 
	 * 
	 * @return The BollingerBands. * @see
	 *         org.trade.strategy.data.bollingerbands.IBollingerBandsDataset
	 *         #getBollingerBandsValue(int, int)
	 */
	public double getBollingerBandsValue(int series, int item) {
		BollingerBandsSeries s = (BollingerBandsSeries) this.data.get(series);
		BollingerBandsItem di = (BollingerBandsItem) s.getDataItem(item);
		return di.getBollingerBands();
	}
