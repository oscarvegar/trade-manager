...
import org.trade.strategy.data.rsi.IRelativeStrengthIndexDataset;
...
public class RelativeStrengthIndexDataset extends AbstractXYDataset implements
	 ...
	 */
	public RelativeStrengthIndexSeries getSeries(int series) {
		if ((series < 0) || (series >= getSeriesCount())) {
			throw new IllegalArgumentException("Series index out of bounds");
		}
		return (RelativeStrengthIndexSeries) this.data.get(series);
	}
	 ...
	 *         org.trade.strategy.data.rsi.IRelativeStrengthIndexDataset
