...
public class PosMgrBreakEvenStrategy extends AbstractStrategyRule {
	...
	private final static Logger _log = LoggerFactory
			.getLogger(PosMgrBreakEvenStrategy.class);
	...
	public PosMgrBreakEvenStrategy(BrokerModel brokerManagerModel,
	...
	public void runStrategy(CandleSeries candleSeries, boolean newBar) {
		...
		try {
			...
			if (startPeriod.isAfter(this.getTradestrategy().getTradingday().getOpen())
				...
				_log.info("LastAuxStopPrice::" + LastAuxStopPrice + ", Symbol::" + this.getSymbol());
			}
