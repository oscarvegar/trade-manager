...
public class MACDDataset extends AbstractXYDataset implements IndicatorDataset,
	 ...
	 */
	public MACDSeries getSeries(int series) {
		if ((series < 0) || (series >= getSeriesCount())) {
			throw new IllegalArgumentException("Series index out of bounds");
		}
		return (MACDSeries) this.data.get(series);
	}
	 ...
	 * 
	 * 
	 * @return The MACD. * @see org.trade.strategy.data.macd.IMACDDataset
	 *         #getMACDValue(int, int)
	 */
	 ...
	 * 
	 * 
	 * @return The Pivot. * @see org.trade.strategy.data.macd.IMACDDataset
	 *         #getMACD(int, int)
	 */
